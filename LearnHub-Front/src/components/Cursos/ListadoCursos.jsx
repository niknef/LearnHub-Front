                    ...
                    <div key={curso._id} className="col-md-4 col-sm-6 col-12 mb-4 d-flex">
                        <div className="card flex-fill d-flex flex-column" style={{ width: '100%' }}>
                            ...
                            <div className="card-body d-flex flex-column">
                                ...
                                <p className="card-text fw-lighter"><strong>Horas:</strong> <i className="bi bi-clock"></i> {curso.horas}</p>
                                <p className="card-text fw-lighter"><strong>Categoría:</strong> {capitalize(curso.categoria)}</p>
                                <div className="mt-auto">
                                    <Link to={"cursos/" + curso._id} className="btn btn-info w-100">
